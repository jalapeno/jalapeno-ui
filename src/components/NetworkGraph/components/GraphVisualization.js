...
const GraphVisualization = ({ elements, layout, style }) => {
  ...
  // Handle tooltips
  useTooltips(cyRef.current, nodeSelectionSids);
  ...
  // Add path highlighting and SID tooltip effect
  useEffect(() => {
  ...
  }, [cyRef.current, elements, selectedPath, pathSids]);
